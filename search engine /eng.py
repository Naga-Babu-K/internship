...
if st.button("Search_top_movies"):
    ...
    import pandas as pd
    df = pd.read_csv(r"C:\Users\Erik\Documents\Innomatics assignments\internship files\intern projects\internship projects\machine learning project intern\2.) search engine project\Sub_Titles_with_32.csv")
